  ...
  return (
    <aside style={{
      ...
      <div style={{ padding: '0 1.5rem', marginBottom: '2rem' }}>
        <div style={{ fontFamily: 'var(--font-display)', fontWeight: 800, fontSize: '1.2rem', color: 'var(--cyan)', letterSpacing: '-0.02em' }}>
          FACE<span style={{ color: 'var(--text-primary)' }}>VISION</span>
        </div>
        <div style={{ fontSize: '0.62rem', color: 'var(--text-muted)', marginTop: '0.15rem', letterSpacing: '0.12em' }}>
      ...
      {/* Footer */}
      <div style={{ padding: '1rem 1.5rem', borderTop: '1px solid var(--bg-border)', fontSize: '0.62rem', color: 'var(--text-muted)', lineHeight: 1.8 }}>
